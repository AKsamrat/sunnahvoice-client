...
export default function HomeVideoSection() {
  const { items: videos } = useMedia("video", 6);
  const content = mediaLabels.video;

  return (
    <section
      id="videos"
      className="relative mx-auto max-w-7xl border-t border-emerald-950/10 px-10 py-8 dark:border-white/10 md:py-10"
    >
